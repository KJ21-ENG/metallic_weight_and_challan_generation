...
export function ManagementPage() {
    ...
    return (_jsxs(Stack, { spacing: 2, children: [_jsx(Typography, { variant: "h5", children: "Challans" }), _jsx(Card, { children: _jsx(CardContent, { children: _jsxs(Grid, { container: true, spacing: 2, alignItems: "center", children: [_jsx(Grid, { item: true, xs: 12, sm: 3, children: _jsx(TextField, { fullWidth: true, label: "From", type: "date", value: from, onChange: e => setFrom(e.target.value), InputLabelProps: { shrink: true } }) }), _jsx(Grid, { item: true, xs: 12, sm: 3, children: _jsx(TextField, { fullWidth: true, label: "To", type: "date", value: to, onChange: e => setTo(e.target.value), InputLabelProps: { shrink: true } }) }), _jsx(Grid, { item: true, xs: 12, sm: 'auto', children: _jsx(Button, { onClick: search, children: "Search" }) })] }) }) }), _jsx(TableContainer, { component: Paper, children: _jsxs(Table, { size: "small", children: [_jsx(TableHead, { children: _jsxs(TableRow, { children: [_jsx(TableCell, { children: "ID" }), _jsx(TableCell, { children: "Challan No" }), _jsx(TableCell, { children: "Date" }), _jsx(TableCell, { children: "Customer" }), _jsx(TableCell, { align: "right", children: "Total Bobbin" }), _jsx(TableCell, { align: "right", children: "Total Net (kg)" }), _jsx(TableCell, { align: "right", children: "Actions" })] }) }), _jsx(TableBody, { children: rows.map(r => (_jsxs(TableRow, { children: [_jsx(TableCell, { children: r.id }), _jsx(TableCell, { children: String(r.challan_no).padStart(6, '0') }), _jsx(TableCell, { children: dayjs(r.date).format('DD/MM/YYYY') }), _jsx(TableCell, { children: r.customer_name }), _jsx(TableCell, { align: "right", children: r.total_bob_qty }), _jsx(TableCell, { align: "right", children: Number(r.total_net_wt).toFixed(3) }), _jsx(TableCell, { align: "right", children: _jsxs(Stack, { direction: "row", spacing: 1, justifyContent: "flex-end", children: [_jsx(Button, { size: "small", onClick: () => openPdf(r), children: "Open PDF" }), _jsx(Button, { size: "small", onClick: () => startEdit(r), children: "Edit" }), _jsx(Button, { size: "small", color: "error", variant: "outlined", onClick: () => softDelete(r), children: "Delete" })] }) })] }, r.id))) })] }) })] }));
}
