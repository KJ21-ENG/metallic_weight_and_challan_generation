...
export function ManagementPage() {
    ...
    useEffect(() => { fetchPage(1); (async () => { if (customers.length === 0)
        setCustomers(await getOptions('customers')); })(); }, []);
    async function fetchPage(p) {
        const params = { from, to, page: p, limit: LIMIT };
        if (customerId !== '')
    ...
    if (editing) {
        return (_jsxs(Stack, { spacing: 2, children: [_jsxs(Typography, { variant: "h6", children: ["Edit Challan #", String(editing.challan_no).padStart(6, '0')] }), _jsx(Card, { children: _jsx(CardContent, { children: _jsxs(Grid, { container: true, spacing: 2, children: [_jsx(Grid, { item: true, xs: 12, sm: 3, children: _jsx(TextField, { fullWidth: true, label: "Date", type: "date", value: editing.date, onChange: e => setEditing({ ...editing, date: e.target.value }), InputLabelProps: { shrink: true } }) }), _jsx(Grid, { item: true, xs: 12, sm: 5, children: _jsxs(FormControl, { fullWidth: true, children: [_jsx(InputLabel, { children: "Customer" }), _jsx(Select, { label: "Customer", value: editing.customer_id, onChange: e => setEditing({ ...editing, customer_id: Number(e.target.value) }), children: customers.map(c => _jsx(MenuItem, { value: c.id, children: c.name }, c.id)) })] }) }), _jsx(Grid, { item: true, xs: 12, sm: 4, children: _jsxs(FormControl, { fullWidth: true, children: [_jsx(InputLabel, { children: "Shift" }), _jsx(Select, { label: "Shift", value: editing.shift_id, onChange: e => setEditing({ ...editing, shift_id: Number(e.target.value) }), children: shifts.map(s => _jsx(MenuItem, { value: s.id, children: s.name }, s.id)) })] }) })] }) }) }), _jsx(Card, { children: _jsxs(CardContent, { children: [_jsx(TableContainer, { component: Paper, sx: { mt: 2 }, children: _jsxs(Table, { size: "small", children: [_jsx(TableHead, { children: _jsxs(TableRow, { children: [_jsx(TableCell, { children: "#" }), _jsx(TableCell, { children: "Metallic" }), _jsx(TableCell, { children: "Cut" }), _jsx(TableCell, { children: "Operator" }), _jsx(TableCell, { children: "Helper" }), _jsx(TableCell, { children: "Bob" }), _jsx(TableCell, { children: "Box" }), _jsx(TableCell, { align: "right", children: "Qty" }), _jsx(TableCell, { align: "right", children: "Gross" }), _jsx(TableCell, { align: "right", children: "Tare" }), _jsx(TableCell, { align: "right", children: "Net" }), _jsx(TableCell, {})] }) }), _jsxs(TableBody, { children: [items.map((it, i) => {
                                                    ...
                                                    return (_jsxs(TableRow, { sx: { '& td': { borderTop: '1px solid rgba(0,0,0,0.12)' } }, children: [_jsx(TableCell, { colSpan: 7, sx: { pl: 2 }, children: _jsx("b", { children: "Totals" }) }), _jsx(TableCell, { align: "right", children: _jsx("b", { children: totals.qty }) }), _jsx(TableCell, { align: "right", children: "\u00A0" }), _jsx(TableCell, { align: "right", children: "\u00A0" }), _jsx(TableCell, { align: "right", children: _jsx("b", { children: totals.net.toFixed(3) }) }), _jsx(TableCell, {})] }));
    ...
    return (_jsxs(Stack, { spacing: 2, children: [_jsx(Typography, { variant: "h5", children: "Challans" }), _jsx(Card, { children: _jsx(CardContent, { children: _jsxs(Grid, { container: true, spacing: 2, alignItems: "center", children: [_jsx(Grid, { item: true, xs: 12, sm: 2, children: _jsx(TextField, { fullWidth: true, label: "From", type: "date", value: from, onChange: e => setFrom(e.target.value), InputLabelProps: { shrink: true } }) }), _jsx(Grid, { item: true, xs: 12, sm: 2, children: _jsx(TextField, { fullWidth: true, label: "To", type: "date", value: to, onChange: e => setTo(e.target.value), InputLabelProps: { shrink: true } }) }), _jsx(Grid, { item: true, xs: 12, sm: 3, children: _jsxs(FormControl, { fullWidth: true, children: [_jsx(InputLabel, { children: "Customer" }), _jsxs(Select, { label: "Customer", value: customerId, onChange: e => setCustomerId(e.target.value), children: [_jsx(MenuItem, { value: "", children: _jsx("em", { children: "All" }) }), customers.map(c => _jsx(MenuItem, { value: c.id, children: c.name }, c.id))] })] }) }), _jsx(Grid, { item: true, xs: 12, sm: 2, children: _jsx(TextField, { fullWidth: true, label: "Challan No", value: challanNo, onChange: e => setChallanNo(e.target.value) }) }), _jsx(Grid, { item: true, xs: 12, sm: 'auto', children: _jsx(Button, { onClick: search, children: "Search" }) })] }) }) }), _jsxs(Box, { sx: { display: 'flex', flexDirection: 'column', minHeight: 520 }, children: [_jsx(TableContainer, { component: Paper, sx: { flex: 1 }, children: _jsxs(Table, { size: "small", children: [_jsx(TableHead, { children: _jsxs(TableRow, { children: [_jsx(TableCell, { children: "Challan No" }), _jsx(TableCell, { children: "Date" }), _jsx(TableCell, { children: "Customer" }), _jsx(TableCell, { align: "right", children: "Total Bobbin" }), _jsx(TableCell, { align: "right", children: "Total Net (kg)" }), _jsx(TableCell, { align: "right", children: "Actions" })] }) }), _jsx(TableBody, { children: rows.map(r => (_jsxs(TableRow, { children: [_jsx(TableCell, { children: String(r.challan_no).padStart(6, '0') }), _jsx(TableCell, { children: dayjs(r.date).format('DD/MM/YYYY') }), _jsx(TableCell, { children: r.customer_name }), _jsx(TableCell, { align: "right", children: r.total_bob_qty }), _jsx(TableCell, { align: "right", children: Number(r.total_net_wt).toFixed(3) }), _jsx(TableCell, { align: "right", children: _jsxs(Stack, { direction: "row", spacing: 1, justifyContent: "flex-end", children: [_jsx(Button, { size: "small", onClick: () => openPdf(r), children: "Open PDF" }), _jsx(Button, { size: "small", onClick: () => startEdit(r), children: "Edit" }), _jsx(Button, { size: "small", color: "error", variant: "outlined", onClick: () => softDelete(r), children: "Delete" })] }) })] }, r.id))) })] }) }), _jsx(Box, { sx: { display: 'flex', justifyContent: 'center', mt: 2 }, children: _jsx(Pagination, { count: Math.ceil(total / LIMIT) || 1, page: page, onChange: (_, p) => fetchPage(p), color: "primary" }) })] }), _jsxs(Dialog, { open: !!deleteRow, onClose: () => setDeleteRow(null), maxWidth: "sm", children: [_jsxs(DialogTitle, { children: ["Delete Challan #", deleteRow ? String(deleteRow.challan_no).padStart(6, '0') : ''] }), _jsx(DialogContent, { children: _jsx(TextField, { label: "Reason", fullWidth: true, value: deleteReason, onChange: e => setDeleteReason(e.target.value), placeholder: "Enter reason", InputLabelProps: {
                                sx: {
                                    whiteSpace: 'nowrap',
                                    overflow: 'hidden',
                                    textOverflow: 'ellipsis'
                                }
                            }, sx: { mt: 1 } }) }), _jsxs(DialogActions, { children: [_jsx(Button, { onClick: () => setDeleteRow(null), variant: "outlined", children: "Cancel" }), _jsx(Button, { onClick: confirmDelete, color: "error", children: "Delete" })] })] })] }));
}
